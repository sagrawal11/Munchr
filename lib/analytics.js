...
export const track = {
  ...
  // Explicit "I wish this machine had X" request — the strongest demand signal, and the
  // primary capture mechanism for low-traffic sites (offices) via a QR code on the machine.
  productRequested: (query, buildingId = null, machineId = null, campus = null) =>
    trackEvent('product_requested', { query, normalized_query: (query || '').toLowerCase(), building_id: buildingId, machine_id: machineId, campus }),
